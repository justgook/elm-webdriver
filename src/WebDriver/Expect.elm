    ...
    let
        result =
            if List.isEmpty list then
                ...
                allHelp list query
    in
    Task.fail "IMPLEMENT ME!! Expect.all"
...
allHelp list query =
    ...
    --             outcome ->
    --                 outcome
    Task.fail "IMPLEMENT ME!! Expect.allHelp"
...
reportCollectionFailure comparison expected actual missingKeys extraKeys =
    ...
    Task.fail "IMPLEMENT ME!! Expect.reportCollectionFailure"
...
listDiffToString : Int -> String -> { expected : List String, actual : List String } -> { originalExpected : List String, originalActual : List String } -> String
